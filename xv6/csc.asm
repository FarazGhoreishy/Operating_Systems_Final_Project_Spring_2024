  ...
  15:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  1d:	50                   	push   %eax
  1e:	50                   	push   %eax
  1f:	68 78 07 00 00       	push   $0x778
  24:	6a 02                	push   $0x2
  26:	e8 e5 03 00 00       	call   410 <printf>
        exit();
  ...
  36:	e8 05 02 00 00       	call   240 <atoi>
  3b:	89 04 24             	mov    %eax,(%esp)
  3e:	e8 10 03 00 00       	call   353 <csc>
    exit();
  43:	e8 6b 02 00 00       	call   2b3 <exit>
  48:	66 90                	xchg   %ax,%ax
  4a:	66 90                	xchg   %ax,%ax
  4c:	66 90                	xchg   %ax,%ax
  4e:	66 90                	xchg   %ax,%ax
...
00000353 <csc>:
 353:	b8 45 00 00 00       	mov    $0x45,%eax
 358:	cd 40                	int    $0x40
 35a:	c3                   	ret    
