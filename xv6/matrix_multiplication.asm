...
_matrix_multiplication:     file format elf32-i386
...
int main(int argc, char *argv[]) 
{
  ...
  11:	57                   	push   %edi
  12:	56                   	push   %esi
  13:	8d 75 c4             	lea    -0x3c(%ebp),%esi
  16:	53                   	push   %ebx
  17:	8d 9d 7c ff ff ff    	lea    -0x84(%ebp),%ebx
  1d:	51                   	push   %ecx
  1e:	81 ec 88 00 00 00    	sub    $0x88,%esp
    int A[MATRIX_SIZE][MATRIX_SIZE] = 
  24:	c7 45 80 02 00 00 00 	movl   $0x2,-0x80(%ebp)
  2b:	c7 45 84 03 00 00 00 	movl   $0x3,-0x7c(%ebp)
  32:	c7 45 88 04 00 00 00 	movl   $0x4,-0x78(%ebp)
  39:	c7 45 8c 05 00 00 00 	movl   $0x5,-0x74(%ebp)
  40:	c7 45 90 06 00 00 00 	movl   $0x6,-0x70(%ebp)
  47:	c7 45 94 07 00 00 00 	movl   $0x7,-0x6c(%ebp)
  4e:	c7 45 98 08 00 00 00 	movl   $0x8,-0x68(%ebp)
  55:	c7 45 9c 09 00 00 00 	movl   $0x9,-0x64(%ebp)
        {1, 2, 3},
        {4, 5, 6},
        {7, 8, 9}
    };
  ...
  5c:	c7 45 a4 08 00 00 00 	movl   $0x8,-0x5c(%ebp)
  63:	c7 45 a8 07 00 00 00 	movl   $0x7,-0x58(%ebp)
  6a:	c7 45 ac 06 00 00 00 	movl   $0x6,-0x54(%ebp)
  71:	c7 45 b0 05 00 00 00 	movl   $0x5,-0x50(%ebp)
  78:	c7 45 b4 04 00 00 00 	movl   $0x4,-0x4c(%ebp)
  7f:	c7 45 b8 03 00 00 00 	movl   $0x3,-0x48(%ebp)
  86:	c7 45 bc 02 00 00 00 	movl   $0x2,-0x44(%ebp)
  8d:	c7 45 c0 01 00 00 00 	movl   $0x1,-0x40(%ebp)
  94:	89 b5 6c ff ff ff    	mov    %esi,-0x94(%ebp)
  9a:	c7 85 70 ff ff ff 01 	movl   $0x1,-0x90(%ebp)
  a1:	00 00 00 
  a4:	89 b5 68 ff ff ff    	mov    %esi,-0x98(%ebp)
  ...
  aa:	8b 43 04             	mov    0x4(%ebx),%eax
  ad:	8b 73 08             	mov    0x8(%ebx),%esi
  b0:	8d 55 a0             	lea    -0x60(%ebp),%edx
{
  b3:	8b 8d 6c ff ff ff    	mov    -0x94(%ebp),%ecx
  b9:	89 85 74 ff ff ff    	mov    %eax,-0x8c(%ebp)
  bf:	b8 09 00 00 00       	mov    $0x9,%eax
        {
            for (int k = 0; k < MATRIX_SIZE; k++) 
            {
                C[i][j] += A[i][k] * B[k][j];
  c4:	0f af 85 70 ff ff ff 	imul   -0x90(%ebp),%eax
  cb:	03 01                	add    (%ecx),%eax
  cd:	83 c2 04             	add    $0x4,%edx
  d0:	83 c1 04             	add    $0x4,%ecx
  d3:	89 c7                	mov    %eax,%edi
  d5:	8b 85 74 ff ff ff    	mov    -0x8c(%ebp),%eax
  db:	0f af 42 08          	imul   0x8(%edx),%eax
  df:	01 f8                	add    %edi,%eax
  e1:	8b 7a 14             	mov    0x14(%edx),%edi
  e4:	0f af fe             	imul   %esi,%edi
  e7:	01 f8                	add    %edi,%eax
  e9:	89 41 fc             	mov    %eax,-0x4(%ecx)
        for (int j = 0; j < MATRIX_SIZE; j++) 
  ec:	8d 45 ac             	lea    -0x54(%ebp),%eax
  ef:	39 c2                	cmp    %eax,%edx
  f1:	74 0d                	je     100 <main+0x100>
  f3:	8b 02                	mov    (%edx),%eax
  f5:	eb cd                	jmp    c4 <main+0xc4>
  f7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  fe:	66 90                	xchg   %ax,%ax
    for (int i = 0; i < MATRIX_SIZE; i++) 
 100:	83 c3 0c             	add    $0xc,%ebx
 103:	8d 45 a0             	lea    -0x60(%ebp),%eax
 106:	83 85 6c ff ff ff 0c 	addl   $0xc,-0x94(%ebp)
 10d:	39 c3                	cmp    %eax,%ebx
 10f:	74 0f                	je     120 <main+0x120>
 111:	8b 03                	mov    (%ebx),%eax
 113:	89 85 70 ff ff ff    	mov    %eax,-0x90(%ebp)
 119:	eb 8f                	jmp    aa <main+0xaa>
 ...
 123:	8b b5 68 ff ff ff    	mov    -0x98(%ebp),%esi
 129:	68 a8 08 00 00       	push   $0x8a8
 12e:	6a 01                	push   $0x1
 130:	8d 7e 24             	lea    0x24(%esi),%edi
 ...
 140:	ff 34 9e             	pushl  (%esi,%ebx,4)
        for (int j = 0; j < MATRIX_SIZE; j++) 
 143:	83 c3 01             	add    $0x1,%ebx
            printf(1, "%d ", C[i][j]);
 146:	68 b8 08 00 00       	push   $0x8b8
 14b:	6a 01                	push   $0x1
 14d:	e8 ee 03 00 00       	call   540 <printf>
        for (int j = 0; j < MATRIX_SIZE; j++) 
 152:	83 c4 10             	add    $0x10,%esp
 155:	83 fb 03             	cmp    $0x3,%ebx
 158:	75 e3                	jne    13d <main+0x13d>
        }
        printf(1, "\n");
 15a:	83 ec 08             	sub    $0x8,%esp
 15d:	83 c6 0c             	add    $0xc,%esi
 160:	68 b6 08 00 00       	push   $0x8b6
 165:	6a 01                	push   $0x1
 167:	e8 d4 03 00 00       	call   540 <printf>
    for (int i = 0; i < MATRIX_SIZE; i++) 
 16c:	83 c4 10             	add    $0x10,%esp
 16f:	39 f7                	cmp    %esi,%edi
 171:	75 c8                	jne    13b <main+0x13b>
    }

    exit();
 173:	e8 6b 02 00 00       	call   3e3 <exit>
 ...
 49c:	89 d1                	mov    %edx,%ecx
{
 ...
 4c9:	0f b6 92 c4 08 00 00 	movzbl 0x8c4(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 6c4:	eb 1a                	jmp    6e0 <printf+0x1a0>
          s = "(null)";
 6c6:	bb bc 08 00 00       	mov    $0x8bc,%ebx
        while(*s != 0){
