...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 97 7c 10 80 	movl   $0x80107c97,(%esp)
...
80102020:	68 7e 7a 10 80       	push   $0x80107a7e
...
801037df:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
801037e5:	e8 66 0f 00 00       	call   80104750 <release>
...
80103807:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010380a:	c7 40 14 ef 59 10 80 	movl   $0x801059ef,0x14(%eax)
  p->context = (struct context*)sp;
...
80103819:	e8 82 0f 00 00       	call   801047a0 <memset>
...
80103842:	e8 09 0f 00 00       	call   80104750 <release>
}
...
801038ca:	68 80 77 10 80       	push   $0x80107780
...
801039b7:	e8 f4 35 00 00       	call   80106fb0 <setupkvm>
...
801039d5:	e8 a6 32 00 00       	call   80106c80 <inituvm>
...
80103a43:	68 b0 77 10 80       	push   $0x801077b0
80103a48:	50                   	push   %eax
80103a49:	e8 12 0f 00 00       	call   80104960 <safestrcpy>
  p->cwd = namei("/");
80103a4e:	c7 04 24 b9 77 10 80 	movl   $0x801077b9,(%esp)
...
80103a87:	68 97 77 10 80       	push   $0x80107797
...
80103acf:	e8 9c 30 00 00       	call   80106b70 <switchuvm>
  return 0;
...
80103b0a:	e8 f1 33 00 00       	call   80106f00 <deallocuvm>
...
80103b5c:	e8 1f 35 00 00       	call   80107080 <copyuvm>
...
80103ca0:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ca3:	81 c7 88 00 00 00    	add    $0x88,%edi
80103ca9:	81 ff 54 4f 11 80    	cmp    $0x80114f54,%edi
...
80103cd9:	e8 92 2e 00 00       	call   80106b70 <switchuvm>
...
80103ce4:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
      swtch(&(c->scheduler), p->context);
80103ceb:	e8 d3 0c 00 00       	call   801049c3 <swtch>
      switchkvm();
80103cf0:	e8 5b 2e 00 00       	call   80106b50 <switchkvm>
      if (p->state == RUNNABLE) 
...
80103d2f:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) 
80103d35:	05 88 00 00 00       	add    $0x88,%eax
80103d3a:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80103d3f:	75 df                	jne    80103d20 <scheduler+0xe0>
    release(&ptable.lock);
80103d41:	83 ec 0c             	sub    $0xc,%esp
80103d44:	68 20 2d 11 80       	push   $0x80112d20
80103d49:	e8 02 0a 00 00       	call   80104750 <release>
    sti();
...
80103deb:	68 bb 77 10 80       	push   $0x801077bb
80103df0:	e8 9b c5 ff ff       	call   80100390 <panic>
    panic("sched interruptible");
80103df5:	83 ec 0c             	sub    $0xc,%esp
80103df8:	68 e7 77 10 80       	push   $0x801077e7
80103dfd:	e8 8e c5 ff ff       	call   80100390 <panic>
    panic("sched running");
80103e02:	83 ec 0c             	sub    $0xc,%esp
80103e05:	68 d9 77 10 80       	push   $0x801077d9
80103e0a:	e8 81 c5 ff ff       	call   80100390 <panic>
    panic("sched locks");
80103e0f:	83 ec 0c             	sub    $0xc,%esp
80103e12:	68 cd 77 10 80       	push   $0x801077cd
80103e17:	e8 74 c5 ff ff       	call   80100390 <panic>
...
80103e2a:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103e2d:	e8 5e 07 00 00       	call   80104590 <pushcli>
  c = mycpu();
80103e32:	e8 a9 fa ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103e37:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103e3d:	e8 9e 07 00 00       	call   801045e0 <popcli>
  if(curproc == initproc)
...
80103e9a:	e8 f1 07 00 00       	call   80104690 <acquire>
...
80103f47:	68 08 78 10 80       	push   $0x80107808
80103f4c:	e8 3f c4 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103f51:	83 ec 0c             	sub    $0xc,%esp
80103f54:	68 fb 77 10 80       	push   $0x801077fb
...
80103f70:	e8 1b 07 00 00       	call   80104690 <acquire>
  pushcli();
80103f75:	e8 16 06 00 00       	call   80104590 <pushcli>
  c = mycpu();
80103f7a:	e8 61 f9 ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103f7f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f85:	e8 56 06 00 00       	call   801045e0 <popcli>
...
80103f9d:	e8 ae 07 00 00       	call   80104750 <release>
}
...
80103fc0:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103fc3:	e8 c8 05 00 00       	call   80104590 <pushcli>
  c = mycpu();
80103fc8:	e8 13 f9 ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103fcd:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103fd3:	e8 08 06 00 00       	call   801045e0 <popcli>
  if(p == 0)
...
80103ff4:	e8 97 06 00 00       	call   80104690 <acquire>
    release(lk);
80103ff9:	89 34 24             	mov    %esi,(%esp)
80103ffc:	e8 4f 07 00 00       	call   80104750 <release>
  p->chan = chan;
...
8010401e:	e8 2d 07 00 00       	call   80104750 <release>
    acquire(lk);
...
8010402f:	5d                   	pop    %ebp
    acquire(lk);
80104030:	e9 5b 06 00 00       	jmp    80104690 <acquire>
...
80104059:	68 1a 78 10 80       	push   $0x8010781a
8010405e:	e8 2d c3 ff ff       	call   80100390 <panic>
    panic("sleep");
80104063:	83 ec 0c             	sub    $0xc,%esp
80104066:	68 14 78 10 80       	push   $0x80107814
...
80104112:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104119:	e8 12 2e 00 00       	call   80106f30 <freevm>
        release(&ptable.lock);
...
8010413e:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80104145:	e8 06 06 00 00       	call   80104750 <release>
        return pid;
...
80104163:	e8 e8 05 00 00       	call   80104750 <release>
      return -1;
...
80104183:	e8 08 05 00 00       	call   80104690 <acquire>
...
801041cc:	c9                   	leave  
  release(&ptable.lock);
801041cd:	e9 7e 05 00 00       	jmp    80104750 <release>
...
801041f3:	e8 98 04 00 00       	call   80104690 <acquire>
...
80104235:	e8 16 05 00 00       	call   80104750 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80104250:	e8 fb 04 00 00       	call   80104750 <release>
}
...
80104293:	68 97 7c 10 80       	push   $0x80107c97
80104298:	e8 13 c4 ff ff       	call   801006b0 <cprintf>
8010429d:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042a0:	81 c3 88 00 00 00    	add    $0x88,%ebx
801042a6:	81 fb c0 4f 11 80    	cmp    $0x80114fc0,%ebx
...
801042b7:	74 e7                	je     801042a0 <procdump+0x30>
      state = "???";
801042b9:	ba 2b 78 10 80       	mov    $0x8010782b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801042be:	83 f8 05             	cmp    $0x5,%eax
801042c1:	77 11                	ja     801042d4 <procdump+0x64>
801042c3:	8b 14 85 c0 78 10 80 	mov    -0x7fef8740(,%eax,4),%edx
      state = "???";
801042ca:	b8 2b 78 10 80       	mov    $0x8010782b,%eax
...
801042d9:	68 2f 78 10 80       	push   $0x8010782f
...
80104300:	e8 2b 02 00 00       	call   80104530 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
80104321:	68 81 72 10 80       	push   $0x80107281
...
80104369:	e8 22 03 00 00       	call   80104690 <acquire>
8010436e:	83 c4 10             	add    $0x10,%esp
80104371:	eb 13                	jmp    80104386 <csc+0x36>
80104373:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104377:	90                   	nop
  for (process = ptable.proc; process < &ptable.proc[NPROC]; process++)
80104378:	81 c3 88 00 00 00    	add    $0x88,%ebx
8010437e:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
80104384:	74 2d                	je     801043b3 <csc+0x63>
  {
    if (process->pid == pid)
80104386:	39 73 10             	cmp    %esi,0x10(%ebx)
80104389:	75 ed                	jne    80104378 <csc+0x28>
    {
...
80104391:	ff b3 84 00 00 00    	pushl  0x84(%ebx)
  for (process = ptable.proc; process < &ptable.proc[NPROC]; process++)
80104397:	81 c3 88 00 00 00    	add    $0x88,%ebx
      cprintf("Number of Context Switches for process %s: is %d\n", process->name, process->context_switches);
8010439d:	50                   	push   %eax
8010439e:	68 8c 78 10 80       	push   $0x8010788c
801043a3:	e8 08 c3 ff ff       	call   801006b0 <cprintf>
801043a8:	83 c4 10             	add    $0x10,%esp
  for (process = ptable.proc; process < &ptable.proc[NPROC]; process++)
801043ab:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
801043b1:	75 d3                	jne    80104386 <csc+0x36>
    }
  }
...
801043bb:	e8 90 03 00 00       	call   80104750 <release>
  return 69;
801043c0:	8d 65 f8             	lea    -0x8(%ebp),%esp
801043c3:	b8 45 00 00 00       	mov    $0x45,%eax
801043c8:	5b                   	pop    %ebx
801043c9:	5e                   	pop    %esi
801043ca:	5d                   	pop    %ebp
801043cb:	c3                   	ret    
...
801043de:	68 d8 78 10 80       	push   $0x801078d8
...
8010443d:	e8 6e fb ff ff       	call   80103fb0 <sleep>
  while (lk->locked) {
...
80104498:	e8 d3 fc ff ff       	call   80104170 <wakeup>
  release(&lk->lk);
...
80104625:	68 e3 78 10 80       	push   $0x801078e3
8010462a:	e8 61 bd ff ff       	call   80100390 <panic>
    panic("popcli");
8010462f:	83 ec 0c             	sub    $0xc,%esp
80104632:	68 fa 78 10 80       	push   $0x801078fa
...
80104737:	68 01 79 10 80       	push   $0x80107901
...
80104790:	68 09 79 10 80       	push   $0x80107909
...
80104b8b:	83 fa 44             	cmp    $0x44,%edx
80104b8e:	77 20                	ja     80104bb0 <syscall+0x40>
80104b90:	8b 14 85 40 79 10 80 	mov    -0x7fef86c0(,%eax,4),%edx
...
80104bb8:	68 11 79 10 80       	push   $0x80107911
...
80104d14:	68 74 7a 10 80       	push   $0x80107a74
...
80104d2c:	68 73 7a 10 80       	push   $0x80107a73
...
80104d41:	68 67 7a 10 80       	push   $0x80107a67
...
80104d5f:	68 76 7a 10 80       	push   $0x80107a76
80104d64:	e8 27 b6 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104d69:	83 ec 0c             	sub    $0xc,%esp
80104d6c:	68 58 7a 10 80       	push   $0x80107a58
...
80104da4:	e8 c7 eb ff ff       	call   80103970 <myproc>
...
80104ded:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104def:	e8 7c eb ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80104f37:	78 27                	js     80104f60 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104f39:	e8 32 ea ff ff       	call   80103970 <myproc>
...
8010515d:	58                   	pop    %eax
8010515e:	5a                   	pop    %edx
8010515f:	68 74 7a 10 80       	push   $0x80107a74
...
80105178:	68 73 7a 10 80       	push   $0x80107a73
...
80105367:	74 23                	je     8010538c <sys_open+0x9c>
  struct proc *curproc = myproc();
80105369:	e8 02 e6 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105549:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
8010554c:	e8 1f e4 ff ff       	call   80103970 <myproc>
...
8010572b:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
8010572d:	e8 3e e2 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105777:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010577a:	e8 f1 e1 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105796:	75 f0                	jne    80105788 <sys_pipe+0x98>
      myproc()->ofile[fd0] = 0;
80105798:	e8 d3 e1 ff ff       	call   80103970 <myproc>
...
801057d0:	f3 0f 1e fb          	endbr32 
  return fork();
801057d4:	e9 47 e3 ff ff       	jmp    80103b20 <fork>
...
801057e7:	83 ec 08             	sub    $0x8,%esp
  exit();
801057ea:	e8 31 e6 ff ff       	call   80103e20 <exit>
...
80105800:	f3 0f 1e fb          	endbr32 
  return wait();
80105804:	e9 67 e8 ff ff       	jmp    80104070 <wait>
...
80105832:	e8 a9 e9 ff ff       	call   801041e0 <kill>
...
80105857:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
8010585a:	e8 11 e1 ff ff       	call   80103970 <myproc>
...
8010588b:	78 23                	js     801058b0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
8010588d:	e8 de e0 ff ff       	call   80103970 <myproc>
  if(growproc(n) < 0)
...
8010589a:	e8 01 e2 ff ff       	call   80103aa0 <growproc>
...
801058e4:	68 60 4f 11 80       	push   $0x80114f60
801058e9:	e8 a2 ed ff ff       	call   80104690 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801058ee:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801058f1:	8b 1d a0 57 11 80    	mov    0x801157a0,%ebx
  while(ticks - ticks0 < n){
...
80105908:	68 a0 57 11 80       	push   $0x801157a0
8010590d:	e8 9e e6 ff ff       	call   80103fb0 <sleep>
  while(ticks - ticks0 < n){
80105912:	a1 a0 57 11 80       	mov    0x801157a0,%eax
...
80105930:	68 60 4f 11 80       	push   $0x80114f60
...
80105953:	68 60 4f 11 80       	push   $0x80114f60
...
80105978:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
8010597b:	68 60 4f 11 80       	push   $0x80114f60
80105980:	e8 0b ed ff ff       	call   80104690 <acquire>
  xticks = ticks;
80105985:	8b 1d a0 57 11 80    	mov    0x801157a0,%ebx
  release(&tickslock);
8010598b:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
...
801059b0:	e8 cb f0 ff ff       	call   80104a80 <argint>
801059b5:	83 c4 10             	add    $0x10,%esp
801059b8:	85 c0                	test   %eax,%eax
801059ba:	78 14                	js     801059d0 <sys_csc+0x30>
    return -1;
  
  return csc(pid);
801059bc:	83 ec 0c             	sub    $0xc,%esp
801059bf:	ff 75 f4             	pushl  -0xc(%ebp)
801059c2:	e8 89 e9 ff ff       	call   80104350 <csc>
...
80105a17:	c7 04 c5 a2 4f 11 80 	movl   $0x8e000008,-0x7feeb05e(,%eax,8)
80105a1e:	08 00 00 8e 
80105a22:	66 89 14 c5 a0 4f 11 	mov    %dx,-0x7feeb060(,%eax,8)
80105a29:	80 
80105a2a:	c1 ea 10             	shr    $0x10,%edx
80105a2d:	66 89 14 c5 a6 4f 11 	mov    %dx,-0x7feeb05a(,%eax,8)
80105a34:	80 
  for(i = 0; i < 256; i++)
...
80105a47:	c7 05 a2 51 11 80 08 	movl   $0xef000008,0x801151a2
80105a4e:	00 00 ef 
  initlock(&tickslock, "time");
80105a51:	68 b9 7a 10 80       	push   $0x80107ab9
80105a56:	68 60 4f 11 80       	push   $0x80114f60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a5b:	66 a3 a0 51 11 80    	mov    %ax,0x801151a0
80105a61:	c1 e8 10             	shr    $0x10,%eax
80105a64:	66 a3 a6 51 11 80    	mov    %ax,0x801151a6
  initlock(&tickslock, "time");
80105a6a:	e8 a1 ea ff ff       	call   80104510 <initlock>
}
...
80105a8f:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105a93:	b8 a0 4f 11 80       	mov    $0x80114fa0,%eax
...
80105ad4:	3e ff 24 85 60 7b 10 	notrack jmp *-0x7fef84a0(,%eax,4)
80105adb:	80 
    lapiceoi();
    break;
...
80105adc:	e8 8f de ff ff       	call   80103970 <myproc>
...
80105afc:	e8 4f de ff ff       	call   80103950 <cpuid>
...
80105b0d:	e8 5e de ff ff       	call   80103970 <myproc>
80105b12:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105b15:	e8 56 de ff ff       	call   80103970 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105b31:	68 1c 7b 10 80       	push   $0x80107b1c
...
80105b53:	e8 18 de ff ff       	call   80103970 <myproc>
...
80105b70:	e8 fb dd ff ff       	call   80103970 <myproc>
...
80105b91:	e8 da dd ff ff       	call   80103970 <myproc>
...
80105bbb:	e8 00 cd ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105bc0:	e8 ab dd ff ff       	call   80103970 <myproc>
80105bc5:	85 c0                	test   %eax,%eax
80105bc7:	75 8a                	jne    80105b53 <trap+0xa3>
80105bc9:	eb a5                	jmp    80105b70 <trap+0xc0>
    if(cpuid() == 0){
80105bcb:	e8 80 dd ff ff       	call   80103950 <cpuid>
80105bd0:	85 c0                	test   %eax,%eax
80105bd2:	75 e7                	jne    80105bbb <trap+0x10b>
      acquire(&tickslock);
80105bd4:	83 ec 0c             	sub    $0xc,%esp
80105bd7:	68 60 4f 11 80       	push   $0x80114f60
80105bdc:	e8 af ea ff ff       	call   80104690 <acquire>
      wakeup(&ticks);
80105be1:	c7 04 24 a0 57 11 80 	movl   $0x801157a0,(%esp)
      ticks++;
80105be8:	83 05 a0 57 11 80 01 	addl   $0x1,0x801157a0
      wakeup(&ticks);
80105bef:	e8 7c e5 ff ff       	call   80104170 <wakeup>
      release(&tickslock);
80105bf4:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
80105bfb:	e8 50 eb ff ff       	call   80104750 <release>
...
80105c0a:	e8 b1 cc ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c0f:	e8 5c dd ff ff       	call   80103970 <myproc>
...
80105c26:	e8 95 cc ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c2b:	e8 40 dd ff ff       	call   80103970 <myproc>
...
80105c44:	e8 07 dd ff ff       	call   80103950 <cpuid>
80105c49:	57                   	push   %edi
80105c4a:	56                   	push   %esi
80105c4b:	50                   	push   %eax
80105c4c:	68 c4 7a 10 80       	push   $0x80107ac4
...
80105c5b:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c5e:	e8 0d dd ff ff       	call   80103970 <myproc>
...
80105c74:	0f 85 0e ff ff ff    	jne    80105b88 <trap+0xd8>
    yield();
80105c7a:	e8 e1 e2 ff ff       	call   80103f60 <yield>
...
80105c92:	75 3c                	jne    80105cd0 <trap+0x220>
    myproc()->tf = tf;
80105c94:	e8 d7 dc ff ff       	call   80103970 <myproc>
80105c99:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105c9c:	e8 cf ee ff ff       	call   80104b70 <syscall>
    if(myproc()->killed)
...
80105ce8:	68 e8 7a 10 80       	push   $0x80107ae8
80105ced:	e8 be a9 ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105cf2:	83 c4 14             	add    $0x14,%esp
80105cf5:	68 be 7a 10 80       	push   $0x80107abe
...
80105df3:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105df8:	bb e0 7b 10 80       	mov    $0x80107be0,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105e8b:	6a 00                	push   $0x0
  jmp alltraps
80105e8d:	e9 45 fb ff ff       	jmp    801059d7 <alltraps>
...
80105e94:	6a 01                	push   $0x1
  jmp alltraps
80105e96:	e9 3c fb ff ff       	jmp    801059d7 <alltraps>
...
80105e9d:	6a 02                	push   $0x2
  jmp alltraps
80105e9f:	e9 33 fb ff ff       	jmp    801059d7 <alltraps>
...
80105ea6:	6a 03                	push   $0x3
  jmp alltraps
80105ea8:	e9 2a fb ff ff       	jmp    801059d7 <alltraps>
...
80105eaf:	6a 04                	push   $0x4
  jmp alltraps
80105eb1:	e9 21 fb ff ff       	jmp    801059d7 <alltraps>
...
80105eb8:	6a 05                	push   $0x5
  jmp alltraps
80105eba:	e9 18 fb ff ff       	jmp    801059d7 <alltraps>
...
80105ec1:	6a 06                	push   $0x6
  jmp alltraps
80105ec3:	e9 0f fb ff ff       	jmp    801059d7 <alltraps>
...
80105eca:	6a 07                	push   $0x7
  jmp alltraps
80105ecc:	e9 06 fb ff ff       	jmp    801059d7 <alltraps>
...
80105ed1:	6a 08                	push   $0x8
  jmp alltraps
80105ed3:	e9 ff fa ff ff       	jmp    801059d7 <alltraps>
...
80105eda:	6a 09                	push   $0x9
  jmp alltraps
80105edc:	e9 f6 fa ff ff       	jmp    801059d7 <alltraps>
...
80105ee1:	6a 0a                	push   $0xa
  jmp alltraps
80105ee3:	e9 ef fa ff ff       	jmp    801059d7 <alltraps>
...
80105ee8:	6a 0b                	push   $0xb
  jmp alltraps
80105eea:	e9 e8 fa ff ff       	jmp    801059d7 <alltraps>
...
80105eef:	6a 0c                	push   $0xc
  jmp alltraps
80105ef1:	e9 e1 fa ff ff       	jmp    801059d7 <alltraps>
...
80105ef6:	6a 0d                	push   $0xd
  jmp alltraps
80105ef8:	e9 da fa ff ff       	jmp    801059d7 <alltraps>
...
80105f0f:	6a 10                	push   $0x10
  jmp alltraps
80105f11:	e9 c1 fa ff ff       	jmp    801059d7 <alltraps>
...
80105f1f:	6a 12                	push   $0x12
  jmp alltraps
80105f21:	e9 b1 fa ff ff       	jmp    801059d7 <alltraps>
...
80105f28:	6a 13                	push   $0x13
  jmp alltraps
80105f2a:	e9 a8 fa ff ff       	jmp    801059d7 <alltraps>
...
80105f31:	6a 14                	push   $0x14
  jmp alltraps
80105f33:	e9 9f fa ff ff       	jmp    801059d7 <alltraps>
...
80105f3a:	6a 15                	push   $0x15
  jmp alltraps
80105f3c:	e9 96 fa ff ff       	jmp    801059d7 <alltraps>
...
80105f43:	6a 16                	push   $0x16
  jmp alltraps
80105f45:	e9 8d fa ff ff       	jmp    801059d7 <alltraps>
...
80105f4c:	6a 17                	push   $0x17
  jmp alltraps
80105f4e:	e9 84 fa ff ff       	jmp    801059d7 <alltraps>
...
80105f55:	6a 18                	push   $0x18
  jmp alltraps
80105f57:	e9 7b fa ff ff       	jmp    801059d7 <alltraps>
...
80105f5e:	6a 19                	push   $0x19
  jmp alltraps
80105f60:	e9 72 fa ff ff       	jmp    801059d7 <alltraps>
...
80105f67:	6a 1a                	push   $0x1a
  jmp alltraps
80105f69:	e9 69 fa ff ff       	jmp    801059d7 <alltraps>
...
80105f70:	6a 1b                	push   $0x1b
  jmp alltraps
80105f72:	e9 60 fa ff ff       	jmp    801059d7 <alltraps>
...
80105f79:	6a 1c                	push   $0x1c
  jmp alltraps
80105f7b:	e9 57 fa ff ff       	jmp    801059d7 <alltraps>
...
80105f82:	6a 1d                	push   $0x1d
  jmp alltraps
80105f84:	e9 4e fa ff ff       	jmp    801059d7 <alltraps>
...
80105f8b:	6a 1e                	push   $0x1e
  jmp alltraps
80105f8d:	e9 45 fa ff ff       	jmp    801059d7 <alltraps>
...
80105f94:	6a 1f                	push   $0x1f
  jmp alltraps
80105f96:	e9 3c fa ff ff       	jmp    801059d7 <alltraps>
...
80105f9d:	6a 20                	push   $0x20
  jmp alltraps
80105f9f:	e9 33 fa ff ff       	jmp    801059d7 <alltraps>
...
80105fa6:	6a 21                	push   $0x21
  jmp alltraps
80105fa8:	e9 2a fa ff ff       	jmp    801059d7 <alltraps>
...
80105faf:	6a 22                	push   $0x22
  jmp alltraps
80105fb1:	e9 21 fa ff ff       	jmp    801059d7 <alltraps>
...
80105fb8:	6a 23                	push   $0x23
  jmp alltraps
80105fba:	e9 18 fa ff ff       	jmp    801059d7 <alltraps>
...
80105fc1:	6a 24                	push   $0x24
  jmp alltraps
80105fc3:	e9 0f fa ff ff       	jmp    801059d7 <alltraps>
...
80105fca:	6a 25                	push   $0x25
  jmp alltraps
80105fcc:	e9 06 fa ff ff       	jmp    801059d7 <alltraps>
...
80105fd3:	6a 26                	push   $0x26
  jmp alltraps
80105fd5:	e9 fd f9 ff ff       	jmp    801059d7 <alltraps>
...
80105fdc:	6a 27                	push   $0x27
  jmp alltraps
80105fde:	e9 f4 f9 ff ff       	jmp    801059d7 <alltraps>
...
80105fe5:	6a 28                	push   $0x28
  jmp alltraps
80105fe7:	e9 eb f9 ff ff       	jmp    801059d7 <alltraps>
...
80105fee:	6a 29                	push   $0x29
  jmp alltraps
80105ff0:	e9 e2 f9 ff ff       	jmp    801059d7 <alltraps>
...
80105ff7:	6a 2a                	push   $0x2a
  jmp alltraps
80105ff9:	e9 d9 f9 ff ff       	jmp    801059d7 <alltraps>
...
80106000:	6a 2b                	push   $0x2b
  jmp alltraps
80106002:	e9 d0 f9 ff ff       	jmp    801059d7 <alltraps>
...
80106009:	6a 2c                	push   $0x2c
  jmp alltraps
8010600b:	e9 c7 f9 ff ff       	jmp    801059d7 <alltraps>
...
80106012:	6a 2d                	push   $0x2d
  jmp alltraps
80106014:	e9 be f9 ff ff       	jmp    801059d7 <alltraps>
...
8010601b:	6a 2e                	push   $0x2e
  jmp alltraps
8010601d:	e9 b5 f9 ff ff       	jmp    801059d7 <alltraps>
...
80106024:	6a 2f                	push   $0x2f
  jmp alltraps
80106026:	e9 ac f9 ff ff       	jmp    801059d7 <alltraps>
...
8010602d:	6a 30                	push   $0x30
  jmp alltraps
8010602f:	e9 a3 f9 ff ff       	jmp    801059d7 <alltraps>
...
80106036:	6a 31                	push   $0x31
  jmp alltraps
80106038:	e9 9a f9 ff ff       	jmp    801059d7 <alltraps>
...
8010603f:	6a 32                	push   $0x32
  jmp alltraps
80106041:	e9 91 f9 ff ff       	jmp    801059d7 <alltraps>
...
80106048:	6a 33                	push   $0x33
  jmp alltraps
8010604a:	e9 88 f9 ff ff       	jmp    801059d7 <alltraps>
...
80106051:	6a 34                	push   $0x34
  jmp alltraps
80106053:	e9 7f f9 ff ff       	jmp    801059d7 <alltraps>
...
8010605a:	6a 35                	push   $0x35
  jmp alltraps
8010605c:	e9 76 f9 ff ff       	jmp    801059d7 <alltraps>
...
80106063:	6a 36                	push   $0x36
  jmp alltraps
80106065:	e9 6d f9 ff ff       	jmp    801059d7 <alltraps>
...
8010606c:	6a 37                	push   $0x37
  jmp alltraps
8010606e:	e9 64 f9 ff ff       	jmp    801059d7 <alltraps>
...
80106075:	6a 38                	push   $0x38
  jmp alltraps
80106077:	e9 5b f9 ff ff       	jmp    801059d7 <alltraps>
...
8010607e:	6a 39                	push   $0x39
  jmp alltraps
80106080:	e9 52 f9 ff ff       	jmp    801059d7 <alltraps>
...
80106087:	6a 3a                	push   $0x3a
  jmp alltraps
80106089:	e9 49 f9 ff ff       	jmp    801059d7 <alltraps>
...
80106090:	6a 3b                	push   $0x3b
  jmp alltraps
80106092:	e9 40 f9 ff ff       	jmp    801059d7 <alltraps>
...
80106099:	6a 3c                	push   $0x3c
  jmp alltraps
8010609b:	e9 37 f9 ff ff       	jmp    801059d7 <alltraps>
...
801060a2:	6a 3d                	push   $0x3d
  jmp alltraps
801060a4:	e9 2e f9 ff ff       	jmp    801059d7 <alltraps>
...
801060ab:	6a 3e                	push   $0x3e
  jmp alltraps
801060ad:	e9 25 f9 ff ff       	jmp    801059d7 <alltraps>
...
801060b4:	6a 3f                	push   $0x3f
  jmp alltraps
801060b6:	e9 1c f9 ff ff       	jmp    801059d7 <alltraps>
...
801060bd:	6a 40                	push   $0x40
  jmp alltraps
801060bf:	e9 13 f9 ff ff       	jmp    801059d7 <alltraps>
...
801060c6:	6a 41                	push   $0x41
  jmp alltraps
801060c8:	e9 0a f9 ff ff       	jmp    801059d7 <alltraps>
...
801060cf:	6a 42                	push   $0x42
  jmp alltraps
801060d1:	e9 01 f9 ff ff       	jmp    801059d7 <alltraps>
...
801060d8:	6a 43                	push   $0x43
  jmp alltraps
801060da:	e9 f8 f8 ff ff       	jmp    801059d7 <alltraps>
...
801060e1:	6a 44                	push   $0x44
  jmp alltraps
801060e3:	e9 ef f8 ff ff       	jmp    801059d7 <alltraps>
...
801060ea:	6a 45                	push   $0x45
  jmp alltraps
801060ec:	e9 e6 f8 ff ff       	jmp    801059d7 <alltraps>
...
801060f3:	6a 46                	push   $0x46
  jmp alltraps
801060f5:	e9 dd f8 ff ff       	jmp    801059d7 <alltraps>
...
801060fc:	6a 47                	push   $0x47
  jmp alltraps
801060fe:	e9 d4 f8 ff ff       	jmp    801059d7 <alltraps>
...
80106105:	6a 48                	push   $0x48
  jmp alltraps
80106107:	e9 cb f8 ff ff       	jmp    801059d7 <alltraps>
...
8010610e:	6a 49                	push   $0x49
  jmp alltraps
80106110:	e9 c2 f8 ff ff       	jmp    801059d7 <alltraps>
...
80106117:	6a 4a                	push   $0x4a
  jmp alltraps
80106119:	e9 b9 f8 ff ff       	jmp    801059d7 <alltraps>
...
80106120:	6a 4b                	push   $0x4b
  jmp alltraps
80106122:	e9 b0 f8 ff ff       	jmp    801059d7 <alltraps>
...
80106129:	6a 4c                	push   $0x4c
  jmp alltraps
8010612b:	e9 a7 f8 ff ff       	jmp    801059d7 <alltraps>
...
80106132:	6a 4d                	push   $0x4d
  jmp alltraps
80106134:	e9 9e f8 ff ff       	jmp    801059d7 <alltraps>
...
8010613b:	6a 4e                	push   $0x4e
  jmp alltraps
8010613d:	e9 95 f8 ff ff       	jmp    801059d7 <alltraps>
...
80106144:	6a 4f                	push   $0x4f
  jmp alltraps
80106146:	e9 8c f8 ff ff       	jmp    801059d7 <alltraps>
...
8010614d:	6a 50                	push   $0x50
  jmp alltraps
8010614f:	e9 83 f8 ff ff       	jmp    801059d7 <alltraps>
...
80106156:	6a 51                	push   $0x51
  jmp alltraps
80106158:	e9 7a f8 ff ff       	jmp    801059d7 <alltraps>
...
8010615f:	6a 52                	push   $0x52
  jmp alltraps
80106161:	e9 71 f8 ff ff       	jmp    801059d7 <alltraps>
...
80106168:	6a 53                	push   $0x53
  jmp alltraps
8010616a:	e9 68 f8 ff ff       	jmp    801059d7 <alltraps>
...
80106171:	6a 54                	push   $0x54
  jmp alltraps
80106173:	e9 5f f8 ff ff       	jmp    801059d7 <alltraps>
...
8010617a:	6a 55                	push   $0x55
  jmp alltraps
8010617c:	e9 56 f8 ff ff       	jmp    801059d7 <alltraps>
...
80106183:	6a 56                	push   $0x56
  jmp alltraps
80106185:	e9 4d f8 ff ff       	jmp    801059d7 <alltraps>
...
8010618c:	6a 57                	push   $0x57
  jmp alltraps
8010618e:	e9 44 f8 ff ff       	jmp    801059d7 <alltraps>
...
80106195:	6a 58                	push   $0x58
  jmp alltraps
80106197:	e9 3b f8 ff ff       	jmp    801059d7 <alltraps>
...
8010619e:	6a 59                	push   $0x59
  jmp alltraps
801061a0:	e9 32 f8 ff ff       	jmp    801059d7 <alltraps>
...
801061a7:	6a 5a                	push   $0x5a
  jmp alltraps
801061a9:	e9 29 f8 ff ff       	jmp    801059d7 <alltraps>
...
801061b0:	6a 5b                	push   $0x5b
  jmp alltraps
801061b2:	e9 20 f8 ff ff       	jmp    801059d7 <alltraps>
...
801061b9:	6a 5c                	push   $0x5c
  jmp alltraps
801061bb:	e9 17 f8 ff ff       	jmp    801059d7 <alltraps>
...
801061c2:	6a 5d                	push   $0x5d
  jmp alltraps
801061c4:	e9 0e f8 ff ff       	jmp    801059d7 <alltraps>
...
801061cb:	6a 5e                	push   $0x5e
  jmp alltraps
801061cd:	e9 05 f8 ff ff       	jmp    801059d7 <alltraps>
...
801061d4:	6a 5f                	push   $0x5f
  jmp alltraps
801061d6:	e9 fc f7 ff ff       	jmp    801059d7 <alltraps>
...
801061dd:	6a 60                	push   $0x60
  jmp alltraps
801061df:	e9 f3 f7 ff ff       	jmp    801059d7 <alltraps>
...
801061e6:	6a 61                	push   $0x61
  jmp alltraps
801061e8:	e9 ea f7 ff ff       	jmp    801059d7 <alltraps>
...
801061ef:	6a 62                	push   $0x62
  jmp alltraps
801061f1:	e9 e1 f7 ff ff       	jmp    801059d7 <alltraps>
...
801061f8:	6a 63                	push   $0x63
  jmp alltraps
801061fa:	e9 d8 f7 ff ff       	jmp    801059d7 <alltraps>
...
80106201:	6a 64                	push   $0x64
  jmp alltraps
80106203:	e9 cf f7 ff ff       	jmp    801059d7 <alltraps>
...
8010620a:	6a 65                	push   $0x65
  jmp alltraps
8010620c:	e9 c6 f7 ff ff       	jmp    801059d7 <alltraps>
...
80106213:	6a 66                	push   $0x66
  jmp alltraps
80106215:	e9 bd f7 ff ff       	jmp    801059d7 <alltraps>
...
8010621c:	6a 67                	push   $0x67
  jmp alltraps
8010621e:	e9 b4 f7 ff ff       	jmp    801059d7 <alltraps>
...
80106225:	6a 68                	push   $0x68
  jmp alltraps
80106227:	e9 ab f7 ff ff       	jmp    801059d7 <alltraps>
...
8010622e:	6a 69                	push   $0x69
  jmp alltraps
80106230:	e9 a2 f7 ff ff       	jmp    801059d7 <alltraps>
...
80106237:	6a 6a                	push   $0x6a
  jmp alltraps
80106239:	e9 99 f7 ff ff       	jmp    801059d7 <alltraps>
...
80106240:	6a 6b                	push   $0x6b
  jmp alltraps
80106242:	e9 90 f7 ff ff       	jmp    801059d7 <alltraps>
...
80106249:	6a 6c                	push   $0x6c
  jmp alltraps
8010624b:	e9 87 f7 ff ff       	jmp    801059d7 <alltraps>
...
80106252:	6a 6d                	push   $0x6d
  jmp alltraps
80106254:	e9 7e f7 ff ff       	jmp    801059d7 <alltraps>
...
8010625b:	6a 6e                	push   $0x6e
  jmp alltraps
8010625d:	e9 75 f7 ff ff       	jmp    801059d7 <alltraps>
...
80106264:	6a 6f                	push   $0x6f
  jmp alltraps
80106266:	e9 6c f7 ff ff       	jmp    801059d7 <alltraps>
...
8010626d:	6a 70                	push   $0x70
  jmp alltraps
8010626f:	e9 63 f7 ff ff       	jmp    801059d7 <alltraps>
...
80106276:	6a 71                	push   $0x71
  jmp alltraps
80106278:	e9 5a f7 ff ff       	jmp    801059d7 <alltraps>
...
8010627f:	6a 72                	push   $0x72
  jmp alltraps
80106281:	e9 51 f7 ff ff       	jmp    801059d7 <alltraps>
...
80106288:	6a 73                	push   $0x73
  jmp alltraps
8010628a:	e9 48 f7 ff ff       	jmp    801059d7 <alltraps>
...
80106291:	6a 74                	push   $0x74
  jmp alltraps
80106293:	e9 3f f7 ff ff       	jmp    801059d7 <alltraps>
...
8010629a:	6a 75                	push   $0x75
  jmp alltraps
8010629c:	e9 36 f7 ff ff       	jmp    801059d7 <alltraps>
...
801062a3:	6a 76                	push   $0x76
  jmp alltraps
801062a5:	e9 2d f7 ff ff       	jmp    801059d7 <alltraps>
...
801062ac:	6a 77                	push   $0x77
  jmp alltraps
801062ae:	e9 24 f7 ff ff       	jmp    801059d7 <alltraps>
...
801062b5:	6a 78                	push   $0x78
  jmp alltraps
801062b7:	e9 1b f7 ff ff       	jmp    801059d7 <alltraps>
...
801062be:	6a 79                	push   $0x79
  jmp alltraps
801062c0:	e9 12 f7 ff ff       	jmp    801059d7 <alltraps>
...
801062c7:	6a 7a                	push   $0x7a
  jmp alltraps
801062c9:	e9 09 f7 ff ff       	jmp    801059d7 <alltraps>
...
801062d0:	6a 7b                	push   $0x7b
  jmp alltraps
801062d2:	e9 00 f7 ff ff       	jmp    801059d7 <alltraps>
...
801062d9:	6a 7c                	push   $0x7c
  jmp alltraps
801062db:	e9 f7 f6 ff ff       	jmp    801059d7 <alltraps>
...
801062e2:	6a 7d                	push   $0x7d
  jmp alltraps
801062e4:	e9 ee f6 ff ff       	jmp    801059d7 <alltraps>
...
801062eb:	6a 7e                	push   $0x7e
  jmp alltraps
801062ed:	e9 e5 f6 ff ff       	jmp    801059d7 <alltraps>
...
801062f4:	6a 7f                	push   $0x7f
  jmp alltraps
801062f6:	e9 dc f6 ff ff       	jmp    801059d7 <alltraps>
...
801062fd:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106302:	e9 d0 f6 ff ff       	jmp    801059d7 <alltraps>
...
80106315:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010631a:	e9 b8 f6 ff ff       	jmp    801059d7 <alltraps>
...
80106321:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106326:	e9 ac f6 ff ff       	jmp    801059d7 <alltraps>
...
8010695a:	e8 41 de ff ff       	call   801047a0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801069fd:	68 e8 7b 10 80       	push   $0x80107be8
...
80106ac7:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106aca:	e8 81 ce ff ff       	call   80103950 <cpuid>
  pd[0] = size-1;
...
80106b54:	a1 a4 57 11 80       	mov    0x801157a4,%eax
...
80106b98:	0f 84 c2 00 00 00    	je     80106c60 <switchuvm+0xf0>
  pushcli();
80106b9e:	e8 ed d9 ff ff       	call   80104590 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106ba3:	e8 38 cd ff ff       	call   801038e0 <mycpu>
80106ba8:	89 c3                	mov    %eax,%ebx
80106baa:	e8 31 cd ff ff       	call   801038e0 <mycpu>
...
80106bbc:	e8 1f cd ff ff       	call   801038e0 <mycpu>
...
80106cb3:	e8 e8 da ff ff       	call   801047a0 <memset>
...
80106ce6:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106ce7:	e9 54 db ff ff       	jmp    80104840 <memmove>
    panic("inituvm: more than a page");
80106cec:	83 ec 0c             	sub    $0xc,%esp
80106cef:	68 2d 7c 10 80       	push   $0x80107c2d
...
80106e1b:	e8 80 d9 ff ff       	call   801047a0 <memset>
...
80106e59:	68 65 7c 10 80       	push   $0x80107c65
...
80106ebb:	68 7d 7c 10 80       	push   $0x80107c7d
...
80106f9c:	68 99 7c 10 80       	push   $0x80107c99
...
80106fd4:	e8 c7 d7 ff ff       	call   801047a0 <memset>
...
8010703f:	a3 a4 57 11 80       	mov    %eax,0x801157a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80107073:	68 aa 7c 10 80       	push   $0x80107caa
...
801070c0:	e8 7b d7 ff ff       	call   80104840 <memmove>
...
80107159:	68 ce 7c 10 80       	push   $0x80107cce
8010715e:	e8 2d 92 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107163:	83 ec 0c             	sub    $0xc,%esp
80107166:	68 b4 7c 10 80       	push   $0x80107cb4
...
801071ee:	e8 4d d6 ff ff       	call   80104840 <memmove>
    len -= n;
    buf += n;
